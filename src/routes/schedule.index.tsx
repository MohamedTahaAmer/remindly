			...
			<div className="min-h-screen">
										...
										<div className="relative flex gap-6 md:gap-10">
											...
											<div className="flex-shrink-0 w-16 md:w-24 pt-6">
												<div className="relative">
													...
													<span className="block text-right text-sm md:text-base font-display font-semibold text-copper-light">{session.time}</span>
												</div>
											</div>
				...
				<div className="max-w-4xl mx-auto px-6 pb-20">
					<div className="relative p-8 md:p-12 rounded-3xl bg-gradient-to-br from-card to-charcoal border border-border/50 overflow-hidden text-center">
						...
						<div className="relative">
							<h3 className="font-display text-2xl md:text-3xl font-bold text-cream mb-3">Don't Miss a Single Session</h3>
