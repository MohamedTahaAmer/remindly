			...
			<section className="relative min-h-[90vh] flex items-center justify-center px-6 overflow-hidden">
				...
				<div className="relative max-w-5xl mx-auto text-center z-10">
					...
					<p className="text-xl md:text-2xl text-cream/70 font-body max-w-3xl mx-auto mb-10 leading-relaxed">
						Join the world's most celebrated pastry chefs and master bakers for three extraordinary days of masterclasses, demonstrations, and culinary
						inspiration.
					</p>
			...
			<section className="py-20 px-6">
				<div className="max-w-7xl mx-auto">
					<div className="flex items-end justify-between mb-12">
						...
						<Link to="/speakers" className="hidden md:inline-flex items-center gap-2 text-gold hover:text-gold/80 transition-colors font-medium">
							View all speakers
					...
					<div className="md:hidden mt-8 text-center">
						<Link to="/speakers" className="inline-flex items-center gap-2 text-gold hover:text-gold/80 transition-colors font-medium">
							View all speakers
							<ArrowRight className="w-4 h-4" />
						</Link>
					</div>
			...
			<section className="py-20 px-6">
				<div className="max-w-7xl mx-auto">
					<div className="flex items-end justify-between mb-12">
						...
						<Link to="/talks" className="hidden md:inline-flex items-center gap-2 text-gold hover:text-gold/80 transition-colors font-medium">
							View all sessions
							<ArrowRight className="w-4 h-4" />
						</Link>
					</div>
					...
					<div className="md:hidden mt-8 text-center">
						<Link to="/talks" className="inline-flex items-center gap-2 text-gold hover:text-gold/80 transition-colors font-medium">
							View all sessions
							<ArrowRight className="w-4 h-4" />
						</Link>
					</div>
				...
				<div className="max-w-4xl mx-auto text-center">
					<div className="relative p-12 rounded-3xl bg-gradient-to-br from-card to-charcoal border border-border/50 overflow-hidden">
						...
						<div className="relative">
							<h2 className="font-display text-3xl md:text-4xl font-bold text-cream mb-4">Ready to Elevate Your Craft?</h2>
