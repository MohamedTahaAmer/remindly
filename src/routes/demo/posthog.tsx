		...
		<div className="min-h-screen bg-gray-900 text-white p-8">
			<div className="max-w-md mx-auto">
				...
				{!isConfigured && (
					<div className="mb-4 p-4 bg-yellow-900/50 border border-yellow-600 rounded-lg">
						<p className="text-yellow-200 text-sm">
							<strong>Warning:</strong> VITE_POSTHOG_KEY is not configured. Events won't be sent to PostHog. Add it to your{" "}
				...
				<div className="bg-gray-800 rounded-lg p-6">
					<p className="text-gray-400 mb-4">Click the button below to send events to PostHog. Check your PostHog dashboard to see them appear in real-time.</p>
				...
				<p className="mt-4 text-sm text-gray-400">
					Open your{" "}
					<a href="https://app.posthog.com/events" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:text-cyan-300 underline">
						PostHog Events
					</a>{" "}
				...
				<p className="mt-2 text-sm text-gray-400">
					Learn more in the{" "}
					<a href="https://posthog.com/docs/libraries/react" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:text-cyan-300 underline">
						PostHog React docs
					</a>
					.
				</p>
