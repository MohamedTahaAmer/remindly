				...
				>
					<div className="relative group">
						...
						<div className="relative bg-gradient-to-br from-indigo-600 to-purple-600 p-3 rounded-lg">
							<img src="/drizzle.svg" alt="Drizzle Logo" className="w-8 h-8 transform group-hover:scale-110 transition-transform duration-300" />
						</div>
					</div>
				...
				>
					...
					<div className="space-y-2 text-sm">
						...
						<ol className="list-decimal list-inside space-y-2 text-indigo-300/80">
							...
							<li>
								Run: <code className="px-2 py-1 rounded bg-black/30 text-purple-300">bunx --bun drizzle-kit generate</code>
							</li>
							<li>
								Run: <code className="px-2 py-1 rounded bg-black/30 text-purple-300">bunx --bun drizzle-kit migrate</code>
							</li>
							<li>
								Optional: <code className="px-2 py-1 rounded bg-black/30 text-purple-300">bunx --bun drizzle-kit studio</code>
							</li>
						</ol>
					</div>
				</div>
