...
epoll can't express async file I/O because it's readiness-based and files are always "ready". io*uring flips the model to \_completion*:
...
4. **Since then:** Node's tracking issue (nodejs/node #52156, "Enable io*uring by default") was closed as \_not planned*; libuv 1.52 even scrubbed the option from its docs.
